...
<head>
    ...
    <title>Football League | Balbriggan FC</title>
...
<section id="search">
    <div class="container">
        <h1>Football League | Balbriggan FC</h1>
        <form>
...
<section id="main">
    <div class="container">
        <article id="main-col">
            <h1 class="page-title">About Balbriggan FC</h1>
            <p>
                Although Balbriggan was officially formed in 1969, there was life before 1969. Stalwarts such as Michael Ginnetty and Seamus Lawlor constantly remind us of that fact. The Club had existed in 1959/60,1960/61 and 1961/62 seasons before a shortage of local players caused the Club to fold. A team called Ormeau arrived in Leixlip in the early sixties and everyone interested in playing soccer joined this club.George Bendal an ex-Manchester goalkeeper was the main man. Local players at that time included Dave Kelly, Daithi Heffernan, Theo Watkins later to become an International Youth goalkeeper and Christy Maher. When George died in 1966 the club folded .In 1969, their first season Balbriggan fielded two senior teams, playing in A.U.L. Div. 3A Sun. and Leinster Junior League Counties Div. John Giltrap  was the first manager. Our present Club President Brian Watters was the trainer. During the next couple of seasons the 1st team set up a very impressive record going fifty-eight league games undefeated. This run brought the team through the A.U.L. Div. 2 and the A.U.L. Div. 1 as winners. <br>
                <br>
    ...
    <a href="balbriggan.php"><img src="img/carpool.png"></a>
</section>
